...
Source0  : https://files.pythonhosted.org/packages/a2/92/f6bf84b381249b2071c3f3a9d2b92ddca608c0c183c985a5607e6269e80d/azure-mgmt-iotcentral-3.1.0.zip
Summary  : Microsoft Azure IoTCentral Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-iotcentral-python = %{version}-%{release}
Requires: azure-mgmt-iotcentral-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-iotcentral package.
Group: Default
Requires: azure-mgmt-iotcentral-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-iotcentral package.


%package python3
Summary: python3 components for the azure-mgmt-iotcentral package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_iotcentral)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-iotcentral package.


%prep
%setup -q -n azure-mgmt-iotcentral-3.1.0
cd %{_builddir}/azure-mgmt-iotcentral-3.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046515
